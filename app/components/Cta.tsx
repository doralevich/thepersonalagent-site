...
export function ClosingCta({
  heading = "Ready to Meet Your AI Personal Agent?",
  body = "Build your agent online in about fifteen minutes, or schedule a 30-minute consultation and we will show you exactly how it would be configured for your day.",
}: {
  heading?: string;
  body?: string;
}) {
