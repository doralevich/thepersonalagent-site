...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "A chatbot waits to be asked. An agent has a job, its own memory of your week, and permission to act. Here is the difference, in plain terms.",
  ...
  keywords: [
    ...
    "private AI agent",
    "AI personal assistant explained",
  ],
});
...
const COMPARISON = [
  ...
  },
  {
    ...
    agent: "It keeps a working memory of your people, your commitments, and how you write.",
  },
  {
    chatbot: "It can only tell you what to do.",
    agent: "It connects to your inbox and calendar and produces the reply or the booking itself.",
  },
  {
    chatbot: "It is the same product for everyone.",
    agent: "It is configured around your day, your voice, and what it may never send alone.",
  },
  {
