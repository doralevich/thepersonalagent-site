...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "The Personal Agent is built by Apollo Claw, in-house on Long Island. Who builds it, why it exists, and how engagements are handled.",
  path: "/about",
  keywords: [
    "Apollo Claw",
    "David Oralevich",
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-ink leading-relaxed space-y-4">
              ...
              <p>
                ...
                each one purpose-built for a role. The Personal Agent is built on the same
                foundation.
              </p>
              <p>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                The Personal Agent is one of a family of role-specific agents from Apollo
